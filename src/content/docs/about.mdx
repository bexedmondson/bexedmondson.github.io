...
import selfie from './src/assets/bexselfie.png';

<img src={selfie.src} width="250" height="250" style="display: block; padding: 30px; margin: 0 auto" alt="A mirror selfie of Bex with bright pink hair wearing a black leather jacket, looking at the camera, against a blank background." />
